...
theorem auto_sound_u16_sqrt
  -- arguments
  (range_check_ptr a : F)
  -- code is in memory at s.pc
  (hmem : MemAt mem u16_sqrt_code σ.pc)
  ...
  suffices auto_spec : auto_spec_u16_sqrt a _ by
    apply sound_u16_sqrt; apply auto_spec
