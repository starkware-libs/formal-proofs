...
open vm_u128_safe_divmod_known_small_lhs_code
open u128_safe_divmod_known_small_lhs_completeness

variable (mem : Mrel → Mrel) (σ : VmRegisterState)


theorem complete_u128_safe_divmod_known_small_lhs_VerifyBQ_from_spec
    -- arguments
    (range_check a b b_or_q_bound_rc_value bq q r : ℤ)
    -- code is in memory at σ.pc + start offset
    (hmem : ProgAt mem vm_u128_safe_divmod_known_small_lhs_code σ.pc)
    ...
    (h_spec: ∃ (ρ_q ρ_r : ℤ),
               auto_spec_u128_safe_divmod_known_small_lhs_VerifyBQ range_check a b b_or_q_bound_rc_value bq q r ρ_q ρ_r)
  -- conclusion
...
theorem complete_u128_safe_divmod_known_small_lhs_QIsSmall_from_spec
    -- arguments
    (range_check a b b_or_q_bound_rc_value bq q r : ℤ)
    -- code is in memory at σ.pc + start offset
    (hmem : ProgAt mem vm_u128_safe_divmod_known_small_lhs_code σ.pc)
    ...
    (htv_r : val r = mem (exec (σ.ap + 6)))
    (h_spec: ∃ (ρ_q ρ_r : ℤ),
               auto_spec_u128_safe_divmod_known_small_lhs_QIsSmall range_check a b b_or_q_bound_rc_value bq q r ρ_q ρ_r)
  -- conclusion
  : ∃ loc : LocalAssignment (σ.ap + 7) (range_check + 3),
    VmRangeChecked loc.rc_vals (range_check + 3) loc.rc_num u128Limit ∧
  ...
  have h_VerifyBQ := complete_u128_safe_divmod_known_small_lhs_VerifyBQ_from_spec
...
theorem complete_u128_safe_divmod_known_small_lhs_from_spec
    -- arguments
    (range_check a b : ℤ)
    -- code is in memory at σ.pc + start offset
    (hmem : ProgAt mem vm_u128_safe_divmod_known_small_lhs_code σ.pc)
    ...
    (htv_b : val b = mem (exec (σ.ap - 3)))
    (h_spec: ∃ (ρ_q ρ_r : ℤ),
               auto_spec_u128_safe_divmod_known_small_lhs range_check a b ρ_q ρ_r)
  -- conclusion
  ...
  have h_r_ap : val ↑r = Assign mem loc₀ (exec (σ.ap + 6)) := by
    simp only [h_r_exec_pos] ; dsimp [exec_vals] ; ring_nf ; rfl
  have h_QIsSmall := complete_u128_safe_divmod_known_small_lhs_QIsSmall_from_spec
