...
open bounded_int_div_rem_known_small_lhs_code
...
theorem auto_sound_bounded_int_div_rem_known_small_lhs_VerifyBQ
  -- arguments
  (range_check a b b_or_q_bound_rc_value bq q r : F)
  -- code is in memory at σ.pc + start offset
  (hmem : MemAt mem bounded_int_div_rem_known_small_lhs_code σ.pc)
  ...
  : EnsuresbRet νbound mem
    ...
    4 ≤ κ ∧ RcEnsures mem (rcBound F) 4 (mem (σ.fp - 5)) (mem (τ.ap - 3))
      (auto_spec_bounded_int_div_rem_known_small_lhs_VerifyBQ κ range_check a b b_or_q_bound_rc_value bq q r (mem (τ.ap - 2)) (mem (τ.ap - 1)))) :=
by
...
theorem auto_sound_bounded_int_div_rem_known_small_lhs_QIsSmall
  -- arguments
  (range_check a b b_or_q_bound_rc_value bq q r : F)
  -- code is in memory at σ.pc + start offset
  (hmem : MemAt mem bounded_int_div_rem_known_small_lhs_code σ.pc)
  ...
  : EnsuresbRet νbound mem
    ...
    (fun κ τ =>
    4 ≤ κ ∧ RcEnsures mem (rcBound F) 4 (mem (σ.fp - 5)) (mem (τ.ap - 3))
      (auto_spec_bounded_int_div_rem_known_small_lhs_QIsSmall κ range_check a b b_or_q_bound_rc_value bq q r (mem (τ.ap - 2)) (mem (τ.ap - 1)))) :=
by
  -- assert
  ...
  arith_simps
  apply ensuresbRet_trans (auto_sound_bounded_int_div_rem_known_small_lhs_VerifyBQ mem σ
...
theorem auto_sound_bounded_int_div_rem_known_small_lhs
  -- arguments
  (range_check a b : F)
  -- code is in memory at σ.pc + start offset
  (hmem : MemAt mem bounded_int_div_rem_known_small_lhs_code σ.pc)
  ...
  : EnsuresRet mem σ (fun κ τ =>
    4 ≤ κ ∧ RcEnsures mem (rcBound F) 4 (mem (σ.fp - 5)) (mem (τ.ap - 3))
      (spec_bounded_int_div_rem_known_small_lhs κ range_check a b (mem (τ.ap - 2)) (mem (τ.ap - 1)))) :=
by
  ...
  ·
    ...
    · arith_simps ; rw [hblk_range_check_ptr] ; try { norm_cast }
    intro rc_h_range_check
    suffices auto_spec : auto_spec_bounded_int_div_rem_known_small_lhs _ range_check a b _ _ by
      apply sound_bounded_int_div_rem_known_small_lhs ; apply auto_spec
  ...
  have htv_b_or_q_bound_rc_value : b_or_q_bound_rc_value = mem (σ.ap + 3) := by
    exact hl_b_or_q_bound_rc_value
  arith_simps
  apply ensuresbRet_trans (auto_sound_bounded_int_div_rem_known_small_lhs_QIsSmall mem σ
    range_check a b b_or_q_bound_rc_value bq q r
    hmem
    htv_range_check
    htv_a
