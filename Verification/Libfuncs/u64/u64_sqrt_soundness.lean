...
theorem auto_sound_u64_sqrt
  -- arguments
  (range_check_ptr a : F)
  -- code is in memory at s.pc
  (hmem : MemAt mem u64_sqrt_code σ.pc)
  ...
  suffices auto_spec : auto_spec_u64_sqrt a _ by
    apply sound_u64_sqrt; apply auto_spec
