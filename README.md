...
virtual machine semantics and a proof of the correctness of the older Cairo Stone AIR encoding.
...
- Our verification of the Stone algebraic encoding of Cairo execution traces is described in the paper
...
extension [installed](https://lean-lang.org/install/).
