/-
File: ec_compute_slope_soundness.lean
...
/- starkware.cairo.common.secp256r1.ec.compute_slope autogenerated soundness theorem -/
...
theorem auto_sound_compute_slope
    ...
    (h_mem_4 : mem_at mem code_nondet_bigint3 (σ.pc  - 265))
    (h_mem_5 : mem_at mem code_unreduced_mul (σ.pc  - 252))
    (h_mem_7 : mem_at mem code_assert_165_bit (σ.pc  - 180))
    (h_mem_8 : mem_at mem code_verify_zero (σ.pc  - 169))
...
begin
  ...
  { rw hpc19, norm_num2, exact h_mem_8 },
