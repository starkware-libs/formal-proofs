/-
File: ec_assert_nn_le_soundness.lean
...
theorem auto_sound_assert_nn_le
    ...
    (h_mem_1 : mem_at mem code_assert_nn (σ.pc  - 9))
    (h_mem_2 : mem_at mem code_assert_le (σ.pc  - 5))
...
begin
  ...
  { rw hpc3, norm_num2, exact h_mem_1 },
  ...
  { rw hpc7, norm_num2, exact h_mem_2 },
