...
@[reducible] def PRIME_OVER_RC_BOUND := 10633823966279327296825105735305134080
...
begin
  ...
  { rcases rc_valneg with ⟨n, nlt, neq⟩, rw mul_neg_one at neq,
    right, use [valne, n, nlt, neg_eq_iff_eq_neg.mp neq, ret1eq] },
...
def spec_safe_div (mem : F → F) (κ : ℕ) (range_check_ptr value div ρ_range_check_ptr ρ : F) : Prop :=
  true
...
/- safe_div autogenerated specification -/

-- Do not change this definition.
def auto_spec_safe_div (mem : F → F) (κ : ℕ) (range_check_ptr value div ρ_range_check_ptr ρ : F) : Prop :=
  ∃ PRIME_OVER_RC_BOUND : F, PRIME_OVER_RC_BOUND = 10633823966279327296825105735305134080 ∧
  mem range_check_ptr = div - 1 ∧
  is_range_checked (rc_bound F) (div - 1) ∧
  mem (range_check_ptr + 1) = div + (2 ^ 128 - PRIME_OVER_RC_BOUND) ∧
  is_range_checked (rc_bound F) (div + (2 ^ 128 - PRIME_OVER_RC_BOUND)) ∧
  ∃ q : F,
  ∃ δ5_0 : F,
  q = ddiv value div δ5_0 ∧
  ∃ range_check_ptr₁ : F, range_check_ptr₁ = range_check_ptr + 3 ∧
  mem (range_check_ptr₁ - 1) = q ∧
  is_range_checked (rc_bound F) (q) ∧
  8 ≤ κ ∧
  ρ_range_check_ptr = range_check_ptr₁ ∧
  ρ = q

/- safe_div soundness theorem -/

-- Do not change the statement of this theorem. You may change the proof.
theorem sound_safe_div
    {mem : F → F}
    (κ : ℕ)
    (range_check_ptr value div ρ_range_check_ptr ρ : F)
    (h_auto : auto_spec_safe_div mem κ range_check_ptr value div ρ_range_check_ptr ρ) :
  spec_safe_div mem κ range_check_ptr value div ρ_range_check_ptr ρ :=
begin
  trivial
end

-- You may change anything in this definition except the name and arguments.
def spec_safe_mult (mem : F → F) (κ : ℕ) (range_check_ptr first second ρ_range_check_ptr ρ : F) : Prop :=
  true
...
/- safe_mult autogenerated specification -/

-- Do not change this definition.
def auto_spec_safe_mult (mem : F → F) (κ : ℕ) (range_check_ptr first second ρ_range_check_ptr ρ : F) : Prop :=
  ∃ PRIME_OVER_RC_BOUND : F, PRIME_OVER_RC_BOUND = 10633823966279327296825105735305134080 ∧
  mem range_check_ptr = first ∧
  is_range_checked (rc_bound F) (first) ∧
  mem (range_check_ptr + 1) = second ∧
  is_range_checked (rc_bound F) (second) ∧
  mem (range_check_ptr + 2) = second + (2 ^ 128 - PRIME_OVER_RC_BOUND) ∧
  is_range_checked (rc_bound F) (second + (2 ^ 128 - PRIME_OVER_RC_BOUND)) ∧
  ∃ range_check_ptr₁ : F, range_check_ptr₁ = range_check_ptr + 3 ∧
  7 ≤ κ ∧
  ρ_range_check_ptr = range_check_ptr₁ ∧
  ρ = first * second

/- safe_mult soundness theorem -/

-- Do not change the statement of this theorem. You may change the proof.
theorem sound_safe_mult
    {mem : F → F}
    (κ : ℕ)
    (range_check_ptr first second ρ_range_check_ptr ρ : F)
    (h_auto : auto_spec_safe_mult mem κ range_check_ptr first second ρ_range_check_ptr ρ) :
  spec_safe_mult mem κ range_check_ptr first second ρ_range_check_ptr ρ :=
begin
  trivial
end
...
def auto_spec_horner_eval (mem : F → F) (κ : ℕ) (n_coefficients coefficients point ρ_res : F) : Prop :=
  ((n_coefficients = 0 ∧
   ...
   (n_coefficients ≠ 0 ∧
    ...
    κ₁ + 9 ≤ κ ∧
    ρ_res = n_minus_one_res * point + mem (coefficients)))
...
begin
  ...
  { rw [eq_add_of_sub_eq i_n_eq, ←nat.cast_one, ←nat.cast_add] },
  {
    ...
    simp [←add_assoc, ←mul_assoc],
    rw [h_ret0, add_comm, add_left_cancel_iff, i_sum, finset.sum_mul]
  },
end
...
-- You may change anything in this definition except the name and arguments.
def spec_assert_is_power_of_2 (mem : F → F) (κ : ℕ) (x max_pow : F) : Prop :=
  true

/- assert_is_power_of_2 block 3 autogenerated block specification -/

-- Do not change this definition.
def auto_spec_assert_is_power_of_2_block3 (mem : F → F) (κ : ℕ) (x max_pow : F) : Prop :=
  ((x = 1 ∧
    3 ≤ κ) ∨
   (x ≠ 1 ∧
    ∃ (κ₁ : ℕ), spec_assert_is_power_of_2 mem κ₁ (x / (2 : ℤ)) (max_pow - 1)  ∧
    κ₁ + 6 ≤ κ))

/-
-- Function: assert_is_power_of_2
-/

/- assert_is_power_of_2 autogenerated specification -/

-- Do not change this definition.
def auto_spec_assert_is_power_of_2 (mem : F → F) (κ : ℕ) (x max_pow : F) : Prop :=
  ((max_pow = 0 ∧
    x = 1 ∧
    ∃ (κ₁ : ℕ), auto_spec_assert_is_power_of_2_block3 mem κ₁ x max_pow ∧
    κ₁ + 2 ≤ κ) ∨
   (max_pow ≠ 0 ∧
    ∃ (κ₁ : ℕ), auto_spec_assert_is_power_of_2_block3 mem κ₁ x max_pow ∧
    κ₁ + 1 ≤ κ))

/- assert_is_power_of_2 soundness theorem -/

-- Do not change the statement of this theorem. You may change the proof.
theorem sound_assert_is_power_of_2
    {mem : F → F}
    (κ : ℕ)
    (x max_pow : F)
    (h_auto : auto_spec_assert_is_power_of_2 mem κ x max_pow) :
  spec_assert_is_power_of_2 mem κ x max_pow :=
begin
  trivial
end
