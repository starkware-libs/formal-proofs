...
by rw [mprod, nat_degree_multiset_prod_X_sub_C _, multiset.card_map]; refl
...
begin
  by_cases h : (∀ z, ∏ i, (z - a i) = ∏ i, (z - b i)); simp [exceptional_set, h],
...
begin
  ...
  { simp, intros i _, exact fin.elim0 i },
