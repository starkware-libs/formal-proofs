...
def auto_spec_unreduced_mul (mem : F → F) (κ : ℕ) (a b : BigInt3 F) (ρ_res_low : UnreducedBigInt3 F) : Prop :=
  18 ≤ κ ∧
  ρ_res_low = {
...
def spec_unreduced_mul (mem : F → F) (κ : ℕ) (a b : BigInt3 F) (ρ_res_low : UnreducedBigInt3 F) : Prop :=
...
theorem sound_unreduced_mul
    {mem : F → F}
    (κ : ℕ)
    (a b : BigInt3 F) (ρ_res_low : UnreducedBigInt3 F)
...
-- Do not change this definition.
def auto_spec_unreduced_sqr (mem : F → F) (κ : ℕ) (a : BigInt3 F) (ρ_res_low : UnreducedBigInt3 F) : Prop :=
...
-- You may change anything in this definition except the name and arguments.
def spec_unreduced_sqr (mem : F → F) (κ : ℕ) (a : BigInt3 F) (ρ_res_low : UnreducedBigInt3 F) : Prop :=
...
theorem sound_unreduced_sqr
    {mem : F → F}
    (κ : ℕ)
    (a : BigInt3 F) (ρ_res_low : UnreducedBigInt3 F)
...
-- Do not change this definition.
def auto_spec_verify_zero (mem : F → F) (κ : ℕ) (range_check_ptr : F) (val : UnreducedBigInt3 F) (ρ_range_check_ptr : F) : Prop :=
  ∃ q : F,
  ∃ q_biased : F,
  q_biased = q + 2 ^ 127 ∧
...
-- You may change anything in this definition except the name and arguments.
def spec_verify_zero (mem : F → F) (κ : ℕ) (range_check_ptr : F) (val : UnreducedBigInt3 F) (ρ_range_check_ptr : F) : Prop :=
...
theorem sound_verify_zero
    {mem : F → F}
    (κ : ℕ)
    (range_check_ptr : F) (val : UnreducedBigInt3 F) (ρ_range_check_ptr : F)
...
-- Do not change this definition.
def auto_spec_is_zero (mem : F → F) (κ : ℕ) (range_check_ptr : F) (x : BigInt3 F) (ρ_range_check_ptr ρ_res : F) : Prop :=
  ∃ ιχ__temp40 : F,
  ((ιχ__temp40 ≠ 0 ∧
    ...
    ρ_res = 1) ∨
   (ιχ__temp40 = 0 ∧
    ∃ (κ₁ : ℕ) (range_check_ptr₁ : F) (x_inv : BigInt3 F), spec_nondet_bigint3 mem κ₁ range_check_ptr range_check_ptr₁ x_inv ∧
    ∃ (κ₂ : ℕ) (x_x_inv : UnreducedBigInt3 F), spec_unreduced_mul mem κ₂ x x_inv x_x_inv ∧
    ∃ (κ₃ : ℕ) (range_check_ptr₂ : F), spec_verify_zero mem κ₃ range_check_ptr₁ {
      d0 := x_x_inv.d0 - 1,
      d1 := x_x_inv.d1,
      d2 := x_x_inv.d2
...
-- You may change anything in this definition except the name and arguments.
def spec_is_zero (mem : F → F) (κ : ℕ) (range_check_ptr : F) (x : BigInt3 F) (ρ_range_check_ptr ρ_res : F) : Prop :=
  ∀ ix : bigint3, x = ix.toBigInt3 → ix.bounded (2^107) →
...
theorem sound_is_zero
    {mem : F → F}
    (κ : ℕ)
    (range_check_ptr : F) (x : BigInt3 F) (ρ_range_check_ptr ρ_res : F)
...
begin
  ...
  have := h_x_x_inv ix ix_inv xeq x_inv_eq,
...
-- Do not change this definition.
def auto_spec_reduce (mem : F → F) (κ : ℕ) (range_check_ptr : F) (x : UnreducedBigInt3 F) (ρ_range_check_ptr : F) (ρ_reduced_x : BigInt3 F) : Prop :=
  ∃ (κ₁ : ℕ) (range_check_ptr₁ : F) (reduced_x : BigInt3 F), spec_nondet_bigint3 mem κ₁ range_check_ptr range_check_ptr₁ reduced_x ∧
  ∃ (κ₂ : ℕ) (range_check_ptr₂ : F), spec_verify_zero mem κ₂ range_check_ptr₁ {
...
-- You may change anything in this definition except the name and arguments.
def spec_reduce (mem : F → F) (κ : ℕ) (range_check_ptr : F) (x : UnreducedBigInt3 F) (ρ_range_check_ptr : F) (ρ_reduced_x : BigInt3 F) : Prop :=
  ∀ ix : bigint3,
...
theorem sound_reduce
    {mem : F → F}
    (κ : ℕ)
    (range_check_ptr : F) (x : UnreducedBigInt3 F) (ρ_range_check_ptr : F) (ρ_reduced_x : BigInt3 F)
...
-- Do not change this definition.
def auto_spec_validate_reduced_field_element (mem : F → F) (κ : ℕ) (range_check_ptr : F) (val : BigInt3 F) (ρ_range_check_ptr : F) : Prop :=
