...
import .ec_code
import ..ec_spec
import .ec_ec_mul_inner_soundness
...
/- starkware.cairo.common.secp256r1.ec.ec_mul autogenerated soundness theorem -/
...
theorem auto_sound_ec_mul
    ...
    (h_mem_4 : mem_at mem code_nondet_bigint3 (σ.pc  - 606))
    (h_mem_5 : mem_at mem code_unreduced_mul (σ.pc  - 593))
    (h_mem_6 : mem_at mem code_unreduced_sqr (σ.pc  - 555))
    (h_mem_7 : mem_at mem code_assert_165_bit (σ.pc  - 521))
    (h_mem_8 : mem_at mem code_verify_zero (σ.pc  - 510))
    (h_mem_9 : mem_at mem code_is_zero (σ.pc  - 476))
    (h_mem_12 : mem_at mem code_compute_doubling_slope (σ.pc  - 387))
...
begin
  ...
  step_sub hpc12 (auto_sound_ec_mul_inner mem _ range_check_ptr point scalar.d0 86 _ _ _ _ _ _ _ _ _ _ _ _ _ _),
  ...
  { rw hpc13, norm_num2, exact h_mem_8 },
  ...
  step_sub hpc30 (auto_sound_ec_mul_inner mem _ range_check_ptr₁ pow2_0 scalar.d1 86 _ _ _ _ _ _ _ _ _ _ _ _ _ _),
  ...
  { rw hpc31, norm_num2, exact h_mem_8 },
  ...
  step_sub hpc48 (auto_sound_ec_mul_inner mem _ range_check_ptr₂ pow2_1 scalar.d2 84 _ _ _ _ _ _ _ _ _ _ _ _ _ _),
  ...
  step_sub hpc69 (auto_sound_ec_add mem _ range_check_ptr₃ res0 res1 _ _ _ _ _ _ _ _ _ _ _ _ _ _),
  ...
  { rw hpc70, norm_num2, exact h_mem_9 },
  ...
  step_sub hpc77 (auto_sound_ec_add mem _ range_check_ptr₄ res res2 _ _ _ _ _ _ _ _ _ _ _ _ _ _),
  ...
  { rw hpc78, norm_num2, exact h_mem_9 },
